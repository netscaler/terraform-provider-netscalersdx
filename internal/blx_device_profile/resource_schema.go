...
func blxDeviceProfileResourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Description: "Configuration for Device profile for Citrix ADC BLX instances resource.",
...
type blxDeviceProfileModel struct {
...
func blxDeviceProfileGetThePayloadFromtheConfig(ctx context.Context, data *blxDeviceProfileModel) blxDeviceProfileReq {
	tflog.Debug(ctx, "In blxDeviceProfileGetThePayloadFromtheConfig Function")
	blxDeviceProfileReqPayload := blxDeviceProfileReq{
	...
	return blxDeviceProfileReqPayload
}

type blxDeviceProfileReq struct {
