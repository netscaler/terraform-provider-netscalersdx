...
var _ resource.Resource = (*blxDeviceProfileResource)(nil)
var _ resource.ResourceWithConfigure = (*blxDeviceProfileResource)(nil)

func BlxDeviceProfileResource() resource.Resource {
	return &blxDeviceProfileResource{}
}

type blxDeviceProfileResource struct {
	client *service.NitroClient
}

func (r *blxDeviceProfileResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_blx_device_profile"
}

// Configure configures the client resource.
func (r *blxDeviceProfileResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *blxDeviceProfileResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = blxDeviceProfileResourceSchema(ctx)
}

func (r *blxDeviceProfileResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "In Create Method of blx_device_profile Resource")
	...
	blxDeviceProfileReq := blxDeviceProfileGetThePayloadFromtheConfig(ctx, &data)

	endpoint := "blx_device_profile"

	// Create the request
	returnData, err := r.client.AddResource(endpoint, blxDeviceProfileReq)
...
func (r *blxDeviceProfileResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {

	var resId types.String
	req.State.GetAttribute(ctx, path.Root("id"), &resId)
	tflog.Debug(ctx, fmt.Sprintf("In Read Method of blx_device_profile Resource with Id: %s", resId))
	...
	if err != nil {
		...
		tflog.Warn(ctx, fmt.Sprintf("removing resource blx_device_profile: %v from state because it is not present in the remote", data.Id.ValueString()))
		return
	}
...
func (r *blxDeviceProfileResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	tflog.Debug(ctx, "In Update Method of blx_device_profile Resource")
	...
	var state blxDeviceProfileModel
	...
	endpoint := "blx_device_profile"
	requestPayload := blxDeviceProfileGetThePayloadFromtheConfig(ctx, &data)
	data.Id = state.Id
...
func (r *blxDeviceProfileResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	tflog.Debug(ctx, "In Delete Method of blx_device_profile Resource")
