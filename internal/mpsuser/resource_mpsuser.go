...
var _ resource.ResourceWithImportState = (*mpsuserResource)(nil)
...
func (r *mpsuserResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
