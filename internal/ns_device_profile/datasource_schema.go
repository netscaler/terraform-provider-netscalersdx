...
func nsDeviceProfileDataSourceSchema() schema.Schema {
	return schema.Schema{
		Description: "Data source to retrieve information about a ns device profile.",
...
func nsDeviceProfileSetAttrFromGet(ctx context.Context, data *nsDeviceProfileResourceModel, getResponseData map[string]interface{}) *nsDeviceProfileResourceModel {
