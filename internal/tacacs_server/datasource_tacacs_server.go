...
var _ datasource.DataSource = (*tacacsServerDataSource)(nil)

func TacacsServerDataSource() datasource.DataSource {
...
func (d *tacacsServerDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_tacacs_server"
}

func (d *tacacsServerDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *tacacsServerDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = tacacsServerDataSourceSchema()
}
